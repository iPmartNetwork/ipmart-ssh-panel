...
copyPanelRepo(){
   ...
   link=https://github.com/ipmartnetwork/ipmart-ssh-panel/raw/main/app.zip
...
installationInfo(){
    clear
    echo -e "\n"
    bannerText=$(curl -s https://raw.githubusercontent.com/ipmartnetwork/ipmart-ssh-panel/main/ipmart.txt)
    printf "%s" "$bannerText"
    echo -e "\n"
